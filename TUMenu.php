...
<div id="cssmenu">
    <ul>
        ...
        <li class="has-sub"><a href="ViewInstansiLuar.php"><span>Instansi Luar</span></a>
            <ul>
                <li>
                    <a href="AddInstansiLuar.php">Tambah Instansi Luar</a>
                </li>
                <li>
                    <a href="ViewInstansiLuar.php">Lihat Instansi Luar</a>
                </li> 
            </ul>
        </li>
        <li class="has-sub"><a href="ViewOrganisasiInternal.php"><span>Organisasi Internal</span></a>
            <ul>
                <li>
                    <a href="AddOrganisasiInternal.php">Tambah Organisasi Internal</a>
                </li>
                <li>
                    <a href="ViewOrganisasiInternal.php">Lihat Organisasi Internal</a>
                </li> 
            </ul>
        </li>
        <li class="has-sub"><a href="ViewBidangKeilmuan.php"><span>Bidang Keilmuan</span></a>
            <ul>
                <li>
                    <a href="AddBidangKeilmuan.php">Tambah Bidang Keilmuan</a>
                </li>
                <li>
                    <a href="ViewBidangKeilmuan.php">Lihat Bidang Keilmuan</a>
                </li> 
            </ul>
        </li>
    </ul>
...
<!--        <li><a href='#'><span>History Judul TA</span></a> </li>-->
        ...
        <li class="has-sub"><a href="ViewDaftarHadirSeminarTA1.php"><span>Daftar Hadir Seminar TA 1</span></a>
            <ul>
                <li>
                    <a href="AddDaftarHadirSeminarTA1.php">Tambah Daftar Hadir Seminar TA 1</a>
                </li>
                <li>
        ...
        <li class="has-sub"><a href="ViewSeminarTA2.php"><span>Seminar TA 2</span></a>
            <ul>
                <li>
                    <a href="AddSeminarTA2.php">Tambah Seminar TA 2</a>
                </li>
                <li>
        ...
        <li class="has-sub"><a href="ViewSidangTA2.php"><span>Sidang TA 2</span></a>
            <ul>
                <li>
                    <a href="AddSidangTA2.php">Tambah Sidang TA 2</a>
                </li>
                <li>
                    <a href="ViewSidangTA2.php">Lihat Sidang TA 2</a>
                </li> 
            </ul>
        </li>
