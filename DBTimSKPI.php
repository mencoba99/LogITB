...
<div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="DBTimSKPI.php">Tim Kemahasiswaan</a></li>
                            <li class="active">Dashboard Tim Kemahasiswaan</li>
                        </ul>
                    </div>
                </div>
            </div>
	...
	<section id="content">
		...
		<div class="row">
                    <div class="col-lg-2">
                        <?php include 'TimSKPIMenu.php';?>
                    </div>
                    <div class="col-lg-10">
                        <h3>Dashboard Tim Tugas Akhir</h3>
