...
<div id="cssmenu">
    <ul>
        <li><a href="ViewProfile.php"><span >Kelola Akun</span></a></li>
    </ul>
</div>
        <?php if(!isset($_SESSION['usedrole'])||(isset($_SESSION['usedrole'])&&(
                $_SESSION['usedrole']=="Tim_TA" || $_SESSION['usedrole']=="TU_Akademik" ||
                $_SESSION['usedrole']=="Kaprodi" || $_SESSION['usedrole']=="Mahasiswa" || 
...
<div id="cssmenu">
        ...
        <?php if(!isset($_SESSION['usedrole'])||(isset($_SESSION['usedrole'])&&(
                $_SESSION['usedrole']=="Tim_TA" || $_SESSION['usedrole']=="TU_Akademik"
                || $_SESSION['usedrole']=="Kaprodi" || $_SESSION['usedrole']=="Wali"))){?>
        <li><a href="ViewPengambilanMK.php"><span >Pengambilan Mata Kuliah</span></a></li>
        <?php }?>
        <?php if(!isset($_SESSION['usedrole'])||(isset($_SESSION['usedrole'])&&(
                $_SESSION['usedrole']=="TU_Akademik"||$_SESSION['usedrole']=="Kaprodi"))){?>
        <li><a href="ViewDosenWali.php"><span >Dosen Wali</span></a></li>
        <?php }?>
        <?php if(!isset($_SESSION['usedrole'])||(isset($_SESSION['usedrole'])&&$_SESSION['usedrole']=="Wali")){?>
...
<div id="cssmenu">
    <ul>
        ...
        <?php }?>
        <?php if(!isset($_SESSION['usedrole'])||(isset($_SESSION['usedrole'])&&
                ($_SESSION['usedrole']=="TU_Akademik"|| $_SESSION['usedrole']=="Tim_TA"||
                 $_SESSION['usedrole']=="Kaprodi"||$_SESSION['usedrole']=="Wali"||
                 $_SESSION['usedrole']=="Wali"||$_SESSION['usedrole']=="Mahasiswa"||
                 $_SESSION['usedrole']=="Pembimbing_TA"))){?>
        <li><a href="ViewSKBimbinganTA.php">SK Bimbingan TA</a></li>
        <?php }?>
        <?php if(!isset($_SESSION['usedrole'])||(isset($_SESSION['usedrole'])&&(
                $_SESSION['usedrole']=="TU_Akademik"||$_SESSION['usedrole']=="Tim_TA"
                ||$_SESSION['usedrole']=="Mahasiswa" ||$_SESSION['usedrole']=="Pembimbing_TA"))){?>
