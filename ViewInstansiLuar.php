...
include 'controller/InstansiLuar.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Tambah Instansi Luar</li>
                        </ul>
                    </div>
                </div>
            </div>
		...
		<div class="row whitebgc">
                    ...
                    <div class="col-lg-10">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                                $val = $_SESSION['value'];
                                $x = count($val['kodeinstansi']);
                                for($i=0;$i<$x;$i++){
                                    echo "<tr>";
                                    echo "<td>".$val['kodeinstansi'][$i]."</td>";
                                    echo "<td>".$val['jenis'][$i]."</td>";
                                    echo "<td>".$val['namalengkap'][$i]."</td>";
                                    echo "<td>".$val['email'][$i]."</td>";
                                    echo "<td>".$val['notelp'][$i]."</td>";
                                    echo "<td>".$val['namakontak'][$i]."</td>";
                                    echo "<td>";
                                    echo "<form action=\"controller/InstansiLuar.php\" method=\"POST\" enctype=\"multipart/form-data\">";
                                    echo "<input type=\"hidden\" name=\"nip\" value=".$val['kodeinstansi'][$i]." class=\"btn btn-blue\" />";
