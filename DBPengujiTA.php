<?php
    session_start();
    if(!isset($_SESSION['usedrole'])||(isset($_SESSION['usedrole'])&&$_SESSION['usedrole']!="Penguji_TA")){
...
<div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="DBPengujiTA.php">Penguji TA</a></li>
                            <li class="active">Dashboard Penguji TA</li>
                        </ul>
                    </div>
                </div>
            </div>
	...
	<section id="content">
		...
		<div class="row">
                    <div class="col-lg-2">
                        <?php include 'PengujiTAMenu.php';?>
                    </div>
                    <div class="col-lg-10">
                        <h3>Dashboard Penguji TA dengan NIP : xxxxxxxx</h3>
