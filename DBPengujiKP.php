<?php
    session_start();
    if(!isset($_SESSION['usedrole'])||(isset($_SESSION['usedrole'])&&$_SESSION['usedrole']!="Penguji_KP")){
...
<div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="DBPengujiKP.php">Penguji KP</a></li>
                            <li class="active">Dashboard Penguji KP</li>
                        </ul>
                    </div>
                </div>
            </div>
	...
	<section id="content">
		...
		<div class="row">
                    <div class="col-lg-2">
                        <?php include 'PengujiKPMenu.php';?>
                    </div>
                    <div class="col-lg-10">
                        <h3>Dashboard Penguji KP dengan NIP : xxxxxxxx</h3>
